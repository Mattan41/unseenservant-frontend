  ...
  <div>
    ...
    <div v-else-if="messages.length" class="space-y-3 mb-4">
      <div
        ...
        :key="message.id"
        class="bg-[var(--color-surface)] border border-subtle rounded-lg p-3"
      >
        <div class="flex items-start justify-between gap-2">
          <div class="flex-1 min-w-0">
            <div class="flex items-baseline gap-2 mb-1">
              <span class="font-semibold text-sm" style="color: var(--color-third-800)">
            ...
            <p class="text-default whitespace-pre-wrap break-words">
              {{ message.messageBody }}
            </p>
          </div>
    ...
    <!-- Empty state -->
    <div v-else class="py-4 text-center text-muted text-sm italic">
    ...
    <div class="border-t border-subtle pt-3">
      <textarea
        ...
        class="w-full border border-section rounded-lg p-2 text-sm resize-none input-field"
        rows="3"
        maxlength="10000"
